...
Recreate @karraker2006 with data from @siegel2023
...
#   ggplot() +
#   geom_density_ridges(aes(y = year, x = days + ymd("2001-07-14"), fill = comid)) +
#   theme_classic() +
...
mod <- lm(days ~ year*Mountain, data = pred_hatch)
# sjPlot::tab_model(mod)

estimate_means(mod, c("year", "Mountain")) |> 
  plot() +
...
@tang2017 example using females

Evidence for cogradient clinal adaptation where the farthest south population develops the fastest.
