...
Morgan M. Sparks^1,3^, Brian Z. Leavell^2^, Bryan M. Maitland^1^

^1^Rocky Mountain Research Station, U.S. Forest Service, Boise, Idaho, USA

^2^Division of Biological Sciences, Purdue University, West Lafayette, Indiana, USA

^3^Corresponding author, Morgan.Sparks\@usda.gov

keywords: hatchR, developmental phenology, local adaptation, reaction norm, R, Shiny
