...
## Phylogenetic Application: Species Differences in Developmental Rates / Reaction Norms
...
```{r  fig.width=8, fig.height=4, fig.align='center', fig.cap=""}
fig1
```
...
```{r fig.width=8, fig.height=10, fig.align='center', fig.cap=""}
fig3
```
