...
fig4 <- ef_vals_pops |>
  ...
  geom_point() +
  # geom_abline(intercept = 0, slope = .01, linetype = "dashed") +
  labs(x = "Daily Average Temperature (°C)", y = "Effective Value", title = "Figure 4") +
...
|:--------------|:--------------|:--------------|:--------------|:--------------|
| Amphibia | Anura | *Lithobates* | *L. sylvaticus, L. pipiens, L. clamitans, L. palustris* | @moore1939 |
...
|  | Odonata | 7 genera | 14 species | Developmental equations in @pritchard1987 |
|  | Culicidae | *Aedes* | *A. sticticus, A. vexans* |  |
...
| Cephalopoda | Octopoda | *Octopus* | *O. vulgaris, O. mimus* | @márquez2021 |
|  | Myopsida | *Loligo* | *L. vulgaris, L. reynaudii* |  |
|  | Oegopsida | *Illex* | *I. coindetii, I. illecebrosus* |  |
|  |  | *Todarodes* | *T.pacificus* |  |
|  |  | *Ommastrephes* | *O. bartramii* |  |
| Asteroidea | Valvatida | *Odontaster* | *O. meridionalis, O. validus* | @hoegh-guldberg1995 |
|  |  | *Asterina* | *A. miniata* |  |
