...
+--------------+---------------+-----------------+--------------------+---------------------------------------------------------------------------------------------------------+
|              |               | *Dendroctonus*  | *D. ponderosae*    | Régnière et al. (2012) [10.1016/j.jinsphys.2012.01.010](https://doi.org/10.1016/j.jinsphys.2012.01.010) |
+--------------+---------------+-----------------+--------------------+---------------------------------------------------------------------------------------------------------+
|              | Lepidoptera   | *Choristoneura* | *C. occidentalis*  | Régnière et al. (2012) [10.1016/j.jinsphys.2012.01.010](https://doi.org/10.1016/j.jinsphys.2012.01.010) |
+--------------+---------------+-----------------+--------------------+---------------------------------------------------------------------------------------------------------+
|              |               | *Zeiraphera*    | *Z. canadensis*    | Régnière et al. (2012) [10.1016/j.jinsphys.2012.01.010](https://doi.org/10.1016/j.jinsphys.2012.01.010) |
+--------------+---------------+-----------------+--------------------+---------------------------------------------------------------------------------------------------------+
|              | Diptera       | *Bactrocera*    | *B. cucurbitae*    | Régnière et al. (2012) [10.1016/j.jinsphys.2012.01.010](https://doi.org/10.1016/j.jinsphys.2012.01.010) |
+--------------+---------------+-----------------+--------------------+---------------------------------------------------------------------------------------------------------+
| Malacostraca | Decapoda      | *Pontastacus*   | *P. leptodactylus* | @aydin2004                                                                                              |
+--------------+---------------+-----------------+--------------------+---------------------------------------------------------------------------------------------------------+
| Copepoda     | Calanoida     | 11 genera       |                    | Forster et al. (2011) <https://doi.org/10.1086/662174>                                                  |
+--------------+---------------+-----------------+--------------------+---------------------------------------------------------------------------------------------------------+
|              | Cyclopoida    | 3 genera        |                    | Forster et al. (2011) <https://doi.org/10.1086/662174>                                                  |
+--------------+---------------+-----------------+--------------------+---------------------------------------------------------------------------------------------------------+
|              | Harpacticoida | 2 genera        |                    | Forster et al. (2011) <https://doi.org/10.1086/662174>                                                  |
+--------------+---------------+-----------------+--------------------+---------------------------------------------------------------------------------------------------------+
| Cephalopoda  | Octopoda      | *Octopus*       | 2 species          | Márquez et al. (2021) [**https://doi.org/10.1111/raq.12495**](https://doi.org/10.1111/raq.12495)        |
+--------------+---------------+-----------------+--------------------+---------------------------------------------------------------------------------------------------------+
|              | Myopsida      | *Loligo*        | 2 species          | Márquez et al. (2021) [**https://doi.org/10.1111/raq.12495**](https://doi.org/10.1111/raq.12495)        |
+--------------+---------------+-----------------+--------------------+---------------------------------------------------------------------------------------------------------+
|              | Oegopsida     | 3 genera        |                    | Márquez et al. (2021) [**https://doi.org/10.1111/raq.12495**](https://doi.org/10.1111/raq.12495)        |
+--------------+---------------+-----------------+--------------------+---------------------------------------------------------------------------------------------------------+
| Asteroidea   | Valvatida     | 3 genera        |                    | Hoegh-Guldberg & Pearse (1995)                                                                          |
|              |               |                 |                    |                                                                                                         |
|              |               |                 |                    | <https://sci-hub.st/https://doi.org/10.1093/icb/35.4.415>                                               |
+--------------+---------------+-----------------+--------------------+---------------------------------------------------------------------------------------------------------+
...
**BCL Note: Not sure if it's a useful segue between these 2 case studies, but there's a cool paper on wood frog countergradient variation (Skelly 2004 <https://doi.org/10.1111/j.0014-3820.2004.tb01582.x>) that could be a useful eco-evo example of thinking species -\> population?**
...
As with any model of developmental timing, it is important to recognize that temperature is not the sole determinant of phenological events. For embryos, environmentally cued hatching is seen across taxa, wherein variation in hatch timing and developmental stage at hatching can result from myriad abiotic and biotic triggers apart from temperature [Warkentin 2011 <https://doi.org/10.1093/icb/icr017>]. While **hatchR** focuses specifically on temperature-dependent development, it can be integrated with complementary datasets or experimental manipulations to investigate these more complex, context-dependent interactions.
