...
This model explained \~`r round(perf[1,4], 2)*100`% of the variation in developmental timing (adjusted R² = `r round(perf[1,4], 3)`), with year having a significant weak and negative effect (`r round(params[2,2], 2)` days/year, p = 0.001), indicating an overall trend toward faster development consistent with regional warming (Figure 2A). COMID effects captured the persistent differences in thermal regimes among streams, with estimated marginal means ranging from \~15 to \~44 days to hatch across sites (Figure 2B).
